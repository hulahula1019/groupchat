  ...
  <div>
    <div class="main-body-content">
      <div style="display: flex; align-items: flex-start">
        <div style="box-shadow: 0 0 20px #ccc; width: 200px;  margin-right: 10px; border: 2px solid #ddd; border-radius: 5px;">
          <div style="padding: 20px 10px; border-bottom: 2px solid #ddd; color: #000; background-color: #ffffff">在线用户({{ users.length }})
            <br><span style="font-style: italic; font-size: 12px; color: #888888">is online...</span>
          </div>
        ...
        <!--  中间部分  -->
        <div style="box-shadow: 0 0 20px #ccc; width: 50%; border: 2px solid #ddd; border-radius: 5px; background-color: #ffffff;">
          <div style="padding: 20px 0; text-align: center; border-bottom: 2px solid #ddd; color: #000; background-color: #ffffff">聊天室
            <br><span style="font-style: italic; font-size: 12px; color: #888888">chatroom</span>
          </div>
          ...
          <!-- 输入区域 -->
          <div style="padding: 10px 5px; border-top: 2px solid #ddd; display: flex; align-items: center; width: 100%;">
            ...
            <el-button type="primary" @click="send" style="background-color: #1d4359; border: none">发送</el-button>
          </div>
        </div>
        <!--  中间部分结束  -->
      </div>
