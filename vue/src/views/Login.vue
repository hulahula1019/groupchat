      ...
      <div class="login-wrapper" style="width: 400px; height: 320px; margin-left: 500px; background-color:rgb(255,255,255); border-radius: 30px">
        ...
        <div style="text-align: center; height: 320px;">
          <el-form :model="admin">
            ...
            <el-form-item>
              <el-button style="background-color: #1d4359; border: none; width: 70%; margin-top: 10px" type="primary" @click="login()">登 录</el-button>
            </el-form-item>
            <div style="text-align: center">
              <span style="color: #1d4359; font-size: 15px">还没有账号？</span><a href="javascript:void(0)" style="text-decoration: none; font-size: 15px" @click="navRegister">点击注册</a>
            </div>
          </el-form>
        </div>
      </div>
